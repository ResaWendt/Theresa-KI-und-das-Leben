...
4. **TODOs & Prioritäten:** Gib die komplette TODO-Liste aus `context/current-data.md` (Abschnitt "TODOs nach Priorität") formatiert aus — alle Prio-Stufen, Status und Deadlines. Hebe dringende Deadlines hervor.
